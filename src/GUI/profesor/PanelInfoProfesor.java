...
/**
 * Clase que implementa la interfaz información profesor de la aplicación 
 * @author David Bolanios
 *
 */
@SuppressWarnings("serial")
public class PanelInfoProfesor extends AbstractPanel{
	...
	/**
	 * Constructor de la interfaz información profesor
	 * @param usuario
	 * @param rol
	 */
	public PanelInfoProfesor(String usuario, String rol) {	
		initInfoProfesor(usuario,rol);
	}

	/**
	 * Inicializa los atributos y disposición de los elementos de la interfaz infromación profesor
	 * 
	 */
	private void initInfoProfesor(String usuario, String rol) {
		Imagen fondo= new Imagen("fondoProfesor.jpg");
