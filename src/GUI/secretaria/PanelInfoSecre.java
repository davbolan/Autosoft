...
/**
 * Clase que implementa la interfaz información de Secretaria de la aplicación 
 * @author David Bolanios
 *
 */
@SuppressWarnings("serial")
public class PanelInfoSecre extends AbstractPanel{
	 ...
	 */
	public PanelInfoSecre(String usuario, String rol){
