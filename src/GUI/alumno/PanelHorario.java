...
/**
 * Clase que implementa la interfaz horario de alumno de la aplicación 
...
public class PanelHorario extends AbstractPanel implements ReservasObserver{
	...
	private void initPanelHorario() {
		...
		table = new JTable(model){
			private static final long serialVersionUID = 1L;
             URL url = GUI.class.getResource("imagenes/fondoAlumno.jpg");
	...
	public class TableModel extends AbstractTableModel {
		private String[] columnNames = {"Fecha", "Hora", "Profesor"};
		...
		public Object getValueAt(int rowIndex, int columnIndex) {			
			...
			if(!misReservas.isEmpty()){
				...
				String nombreProfe = "No disponible";			
				profesor = controlador.buscarPersonal(misReservas.get(rowIndex).getIdProfesor()); 
				if(profesor != null)
					nombreProfe = profesor.getNombre() + " " + profesor.getApellido()+ "(" + profesor.getDni()+")";;		
